...
#--PJM --stgout "rank=* %r:./out.txt /data/hp120263/k00634/result/huge/%j/out%r.txt"
#--PJM --stgout "rank=* %r:./err.txt /data/hp120263/k00634/result/huge/%j/err%r.txt"
...
MPIEXEC="mpiexec"
#MPIEXEC="mpiexec -mca mpi_print_stats 1 -oferr-proc err.txt -ofout-proc out.txt"
