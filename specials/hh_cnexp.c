...
extern Memb_func* memb_func;
 ...
 "setdata_hh_cnexp", _hoc_setdata,
 "rates_hh_cnexp", _hoc_rates,
 "vtrap_hh_cnexp", _hoc_vtrap,
 0, 0
};
#define vtrap vtrap_hh_cnexp
...
#define _gth 0
#define htau_hh_cnexp _thread1data[0]
#define htau _thread[_gth]._pval[0]
#define hinf_hh_cnexp _thread1data[1]
#define hinf _thread[_gth]._pval[1]
#define mtau_hh_cnexp _thread1data[2]
#define mtau _thread[_gth]._pval[2]
#define minf_hh_cnexp _thread1data[3]
#define minf _thread[_gth]._pval[3]
#define ntau_hh_cnexp _thread1data[4]
#define ntau _thread[_gth]._pval[4]
#define ninf_hh_cnexp _thread1data[5]
#define ninf _thread[_gth]._pval[5]
#define usetable usetable_hh_cnexp
 double usetable = 1;
 /* some parameters have upper and lower limits */
 static HocParmLimits _hoc_parm_limits[] = {
 "gl_hh_cnexp", 0, 1e+09,
 "gkbar_hh_cnexp", 0, 1e+09,
 "gnabar_hh_cnexp", 0, 1e+09,
 "usetable_hh_cnexp", 0, 1,
 0,0,0
};
 ...
 "htau_hh_cnexp", "ms",
 "ntau_hh_cnexp", "ms",
 "gnabar_hh_cnexp", "S/cm2",
 "gkbar_hh_cnexp", "S/cm2",
 "gl_hh_cnexp", "S/cm2",
 "el_hh_cnexp", "mV",
 "gna_hh_cnexp", "S/cm2",
 "gk_hh_cnexp", "S/cm2",
 ...
 "minf_hh_cnexp", &minf_hh_cnexp,
 "hinf_hh_cnexp", &hinf_hh_cnexp,
 "ninf_hh_cnexp", &ninf_hh_cnexp,
 "mtau_hh_cnexp", &mtau_hh_cnexp,
 "htau_hh_cnexp", &htau_hh_cnexp,
 "ntau_hh_cnexp", &ntau_hh_cnexp,
 "usetable_hh_cnexp", &usetable_hh_cnexp,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 //     _nrn_setdata_reg(_mechtype, _setdata);
  ...
  hoc_register_dparam_size(_mechtype, 7);
 	...
 	ivoc_help("help ?1 hh_cnexp /volume1/home/hp120263/k00634/neuron_kplus/specials/sparc64/hh_cnexp.mod\n");
